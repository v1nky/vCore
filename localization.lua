...
L.CastBarIconTooltip = "Adds a spell icon to the player castbar"
...
L.HideBagBar = "Hide Bag Bar and MicroMenu"
L.HideBagBarTooltip = "Hides the Bag Barfrom your UI and makes the MicroMenu mouseover"
