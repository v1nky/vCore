...
function vCore:SetDefaultOptions()
    ...
    vCore:RegisterDefaultSetting("CleanActionBars", true)
    ...
    vCore:RegisterDefaultSetting("MapCoords", true)
    vCore:RegisterDefaultSetting("ResizePlayerCastBar", true)
    vCore:RegisterDefaultSetting("ResizeTargetCastBar", true)
    vCore:RegisterDefaultSetting("ResizeFocusCastBar", true)
    vCore:RegisterDefaultSetting("ResizeFocus", true)
    vCore:RegisterDefaultSetting("SpellID", false)
